  ...
  return (
    <nav className="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <NavLink to="proyecto-grado-egresados/egresados"  className="flex items-center">
          <img src={logo} alt="" />
        ...
        <div className="flex md:order-2">
          <button
          onClick={() => navigate("proyecto-grado-egresados/anuncios")}
            type="button"
        ...
        >
          <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-24 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <NavLink
                to="proyecto-grado-egresados/personal"
            ...
            <li>
              <NavLink
                to="proyecto-grado-egresados/laboral"
                className="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700
                focus:text-blue-500"
              >
                Informacion Laboral
